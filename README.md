...
[![Documentation Status](https://readthedocs.org/projects/the-unibot/badge/?version=latest)](https://the-unibot.readthedocs.io/en/latest/?badge=latest)
Qui si può trovare la documentazione relativa a simple-sql (work in progress): [dcoumentazione](https://the-unibot.readthedocs.io/en/latest/)
