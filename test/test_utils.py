...
def test_get_course_lang():
    url = 'https://www.unibo.it/cycle/second-cycle-degree/curricula/2020/2021/2020Z/2020Z'
...
def test_get_seconds():
    assert Utils.get_seconds('20:00') == (datetime.strptime(
        '20:00', '%H:%M') - datetime.now()).seconds
